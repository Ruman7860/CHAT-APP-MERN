...
const ChatHeader = ({ fetchAgain, setFetchAgain, fetchMessages, onStartVideoCall, onStartAudioCall }) => {
  ...
  return (
    <div className={`p-4 border-b ${!isDarkMode && 'border-black'} flex gap-3 items-center`}>
      ...
      <div className="flex gap-5 text-lg cursor-pointer">
        <FaVideo title="Video Call" onClick={onStartVideoCall} />
        <FaPhoneAlt title="Audio Call" onClick={onStartAudioCall} />
