...
const GroupModal = ({ onClose }) => {
  ...
  return (
    <div className="fixed z-50 top-0 left-0 w-full h-full bg-black bg-opacity-50 flex justify-center items-center">
      <div
        className={`${isDarkMode ? 'bg-black text-white' : 'bg-gray-200 text-black'
          } p-4 sm:p-6 rounded-lg w-11/12 max-w-md max-h-[90vh] z-10 overflow-y-auto`}
      >
        <form action="" onSubmit={handleSubmit} encType='multipart/form-data' >
          ...
          <input
            ...
            value={groupName}
            className={`w-full mb-3 p-2 border ${isDarkMode ? 'border-blue-400' : 'border-black'
